...
public class J18OOP {
    ...
    // 규칙에 맞춰 코드를 짤수 있게 해 줌
    // => 접근제한자는 언제나 public abstract로 고정
    // 클래스와는 달리 다중상속을 지원함
    ...
    public static void main(String[] args) {
        ...
        unit.attack();
        unit.move();
        // scv2.collect();   // 사용 불가 -> Unit3Action에 정의X
...
class SCV3 extends Unit3 implements Unit3Action {
    ...
    @Override
    public void attack() {
        System.out.printf("융합 절단기(%d)로 공격 중...\n", power);
    }
...
class Marine3 extends Unit3 implements Unit3Action {
    ...
    @Override
    public void attack() {
        System.out.printf("가우스 소총(%d)으로 공격 중...\n", power);
    }
...
class Firebat3 extends Unit3 implements Unit3Action {
    ...
    @Override
    public void attack() {
        System.out.printf("화염 방사기(%d)로 공격 중...\n", power);
    }
