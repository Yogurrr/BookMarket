...
public class C05Condition {
    public static void main(String[] args) {
        ...
        // 문자 추출 : charAt(위치) -> 범위를 지정할 수 는 없음
        ...
        if (age >= 18) {
            ...
            System.out.println("투표 불가능한 나이입니다!");
        }
        ...
        // String형 변수 비교 시 == 연산자는 대상의 주소값을 확인
        // 정수, 실수와는 달리 String은 참조자료형이기 때문임
        // 따라서, 문자열 자체를 비교하려면 equals()를 사용해야 함
        ...
        System.out.println("나이는? v2 ");
        int age2 = sc.nextInt();
        String fee = "";

        if (age2 <= 7) fee = "0원";
        else if (age2 <= 13) fee = "450원";
        else if (age2 <= 19) fee = "720원";
        else if (age2 < 70) fee = "1200원";
        else fee = "0원";

        System.out.printf("%d세의 요금은 %s입니다.\n", age2, fee);
        ...
        switch (month) {
            ...
            case 2 :
                switch (isLeapYear) {
                    case "n" :
                    case "N" : lastDay = 28; break;
                    case "y" :
                    case "Y" : lastDay = 29; break;
                    default:
                        System.out.println("잘못 입력하셨습니다!");
                }
        }

        System.out.printf("%d월의 %d일(윤년:%s)까지입니다.", month, lastDay, isLeapYear);
    }
}
