...
import Yogurrr.project.sungjuk.service.SungJukV3ServiceImpl;

public class SungJukV3Main {
    // 성적 처리프로그램 v3
    // 배열과 클래스, 인터페이스, 예외처리, 컬렉션, 파일처리를 이용해서
    // 성적을 입력하면 총점, 평균, 학점을 계산함
    // SungJukV2Main, SungJukVO, SungJukV1cService, SungJukV3ServiceImpl
    // sungjukc3DAO, sungjukc3DAOImpl, sungjukv3.dat
    // 1. 성적 데이터 입력
